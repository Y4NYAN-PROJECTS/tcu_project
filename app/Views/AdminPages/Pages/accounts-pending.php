    ...
    <section class="section">
        <div class="card shadow-sm">
            <div class="card-header text-center">
                <h5 class="mb-0 mt-2">Peding Accounts List</h5>
                <small>List of all Pedings.</small>
            </div>
            <hr class="mt-0">
            <div class="card-body">
                                        ...
                                        <td>
                                            <div class="">
                                                ...
                                                <div class="dropdown-menu shadow-lg">
                                                    <a class="dropdown-item text-success" href="/AdminController/AccountApprove/<?= $user['user_id'] ?>"><i class="bi bi-check me-3"></i> Approve</a>
