                                                ...
                                                <td>
                                                    <div class="">
                                                        ...
                                                        <div class="dropdown-menu shadow-lg">
                                                            ...
                                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#view_details_equipment_modal" data-view-image="<?= $equipment['school_equipment_image_path'] ?>" data-view-serial-number="<?= $equipment['serial_number'] ?>" data-view-building="<?= $equipment['building'] ?>" data-view-room-number="<?= $equipment['room_number'] ?>" data-view-equipment-name="<?= $equipment['equipment_name'] ?>" data-view-brand-model="<?= $equipment['brand_model'] ?>" data-view-color="<?= $equipment['color'] ?>" data-view-description="<?= $equipment['description'] ?>" data-view-status="<?= $equipment['status'] ?>">
